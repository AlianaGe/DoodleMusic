...
def accomapnimentGeneration(piano_roll, pr_matrix, tempo=120):
    ...
    melody_track = pyd.Instrument(program=pyd.instrument_name_to_program('Music Box'))
    texture_track = pyd.Instrument(program=pyd.instrument_name_to_program('Orchestral Harp'))
